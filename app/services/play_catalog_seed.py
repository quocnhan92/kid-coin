...
def seed_play_catalog(db: Session) -> None:
    ...
    games = [
        ...
        PlayGame(
            ...
            is_active=True,
            sort_order=3,
            launch_url="/game/memory-learn",
            meta_json={"icon": "🃏", "route": "/game/memory-learn"},
        ),
        PlayGame(
            id="snake",
            display_name="Rắn săn mồi",
            game_type="arcade",
            hub_zone="reward",
            is_public=False,
        ...
        PlayGame(
            ...
            is_active=True,
            sort_order=21,
            launch_url="/game/2048",
            meta_json={"route": "/game/2048"},
        ),
        PlayGame(
            id="flappy_classic",
            display_name="Flappy Baby",
            game_type="arcade",
            hub_zone="reward",
            is_public=False,
            requires_wallet=True,
            ...
            is_active=True,
            sort_order=22,
            launch_url="/game/flappy",
            meta_json={"route": "/game/flappy"},
        ),
    ]
    db.add_all(games)
